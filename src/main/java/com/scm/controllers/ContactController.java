...
import com.scm.config.AuthFailtureHandler;
...
public class ContactController {
    ...
    // ContactController(ContactRepo contactRepo, AuthFailtureHandler authFailtureHandler, AppConfig appConfig) {
    ...
    public String addContactView(Model model){
        ...
        // contactForm.setName("Prabhakar Kumar");
